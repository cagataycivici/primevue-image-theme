<template>
    ...
    >
        ...
        <div class="mt-1 text-muted-color leading-6">
        ...
        <div class="mt-6 flex flex-wrap items-start gap-6">
            <div class="flex-1 flex flex-col gap-6">
                <div class="border border-surface rounded-3xl p-6 flex flex-col gap-6">
                    ...
                    <p class="text-sm text-muted-color leading-5 mb-0">
                        ...
                        From sock mysteries to subway adventures, join him for a laughter-filled
                        journey!
                    </p>
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="p-2 rounded-2xl flex items-center gap-3 bg-emphasis">
                            ...
                            <div class="flex-1">
                                <div class="text-color text-sm font-medium leading-5">
                                    Jacob Jones
                                </div>
                ...
                <div class="border border-surface rounded-3xl">
                    <div class="pt-6 px-6 flex flex-col gap-6">
                        ...
                        <p class="leading-6 text-muted-color mb-0">
                            Expert in data analysis? Join Data Insights Ltd. as a senior data
                            analyst. Lead in the world of data with us!
                        </p>
            ...
            <div class="flex-1 flex flex-col gap-6">
                <div class="border border-surface rounded-3xl p-6 flex flex-col gap-6">
                    ...
                    <div>
                        <label for="document-name" class="text-color font-medium leading-6"
                            >Document Name
                        </label>
                        ...
                        >
                            ...
                            >
                                <div v-if="files.length > 0" class="px-4 py-0">
                                    ...
                                    <div
                                        class="flex flex-wrap gap-2 grow overflow-auto max-h-[210px]"
                                    >
                                        <div
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        >
                            ...
                            <div class="flex-1 text-sm leading-5 text-color">
                                {{ permission.name }}
                            </div>
                            <RadioButton
                ...
                <div class="border border-surface rounded-3xl p-6">
                    ...
                    <div class="text-2xl font-medium text-color mt-6 leading-8">
                        That's your avatar
                    </div>
                    <div class="leading-6 text-muted-color mt-2">
                    ...
                    <div>
                        ...
                        <div class="mt-4 flex flex-col gap-4">
                            <div class="flex items-center gap-2 justify-between">
                                ...
                                />
                                <div class="flex-1">
                                    <div class="text-sm font-medium text-color leading-5">
                                        Brook Simmons
                                    </div>
            ...
            <div class="flex-1 flex flex-wrap gap-6">
                <div class="flex-1 border border-surface rounded-3xl p-6">
                    <div class="text-color font-medium leading-6 mb-4">Settings</div>
                    <Tabs value="0" :dt="tabStyle">
                        <TabList>
                            <Tab value="0">General</Tab>
                            <Tab value="1">Privacy</Tab>
                        </TabList>
                        <TabPanels>
                            <TabPanel value="0">
                                <div class="flex flex-col gap-4 mt-6">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="leading-6 text-color flex-1">Bluetooh</div>
                            ...
                            <TabPanel value="1">
                                <div class="flex flex-col gap-4 mt-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="leading-6 text-color flex-1">
                                            Location Services
                                        </div>
                ...
                <div class="border border-surface rounded-3xl p-6">
                    ...
                    <div class="mt-4 flex gap-2">
                        <div class="flex-1">
                            <label for="price-min-val" class="leading-6 text-color"
                                >Min Value</label
                            >
                            <InputNumber
                        ...
                        <div class="flex-1">
                            <label for="price-max-val" class="leading-6 text-color"
                                >Max Value</label
                            >
                            <InputNumber
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center gap-4 flex-wrap">
                            <div
                                v-for="(data, index) of priceRangePopularSpecs"
                                :key="index"
                                class="flex align-items-center"
                            >
                                <Checkbox
                                    v-model="priceRangePopularSpecsChecked"
                                    :inputId="data.value"
                                    :name="data.value"
                                    :value="data.value"
                                />
